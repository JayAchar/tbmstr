...
lq_cc_n <- max(params$plots$conversion$liquid$data$cum.event)
...
From `r lq_n` participants who were culture-positive at baseline, `r lq_cc_n` 
culture converted during the first 4 months of treatment. The median days (IQR) 
to culture conversion was `r lq_median_cc`.
...
solid_cc_n <- max(params$plots$conversion$solid$data$cum.event)
...
From `r solid_n` participants who were culture-positive at baseline, 
`r solid_cc_n` culture converted during the first 4 months of treatment. The 
median days (IQR) to culture conversion was `r solid_median_cc`.
...
joint_cc_n <- max(params$plots$conversion$joint$data$cum.event)
...
From `r joint_n` participants who were culture-positive at baseline, 
`r joint_cc_n` culture converted during the first 4 months of treatment. The 
median days (IQR) to culture conversion was `r joint_median_cc`.
