...
This section still requires some analysis to be concluded. Currently, 
baseline culture status is defined by all MGIT cultures before or up to 
7 days after treatment initiation. Culture conversion is derived only from 
MGIT cultures. 

This strict approach needs to be loosened to include an option with LJ culture
alone or in combination with MGIT culture. 
